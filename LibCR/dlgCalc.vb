...
Public Class dlgCalc
    Public ReadOnly Property textbostext() As String
        Get
    ...
    Private Sub btnSquareRoot_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim nextPart As Double
        Double.TryParse(TextBox1.Text, nextPart)
        If nextPart <> 0 Then
    ...
    Private Sub btnPercentage_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim lastPart As Double
    ...
    Private Sub frmCalc_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub dlgCalc_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
    ...
    Private Sub dlgCalc_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
